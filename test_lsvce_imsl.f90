! ifort test_lsvce_imsl.f90 -o lsvce -L../imsl -limsl; lsvce
implicit none
integer :: i,k,j,IA,IER
integer, parameter:: n1=100,m=12,n2=100
integer, parameter:: nskip=21996,nfull=40236
...
real(kind=8), dimension(n2+n1,n2+n1) :: NN5,paortho,DNN5,matr,mq1,mq2,mN11,mN12
